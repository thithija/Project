...
public class pgatway extends AppCompatActivity {
    Button back, pay;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pgatway);
        back=findViewById(R.id.backgat);
        pay = findViewById(R.id.payment);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent register = new Intent(pgatway.this, Main2Activity.class);
            ...
            public void onClick(View v) {
                ...
                new AsyncTask<Void, Void, Void>() {
                    ...
                    protected void onPreExecute() {
                        super.onPreExecute();
                        mProgressDialog = new ProgressDialog(pgatway.this);
                        mProgressDialog.setMessage("Payment Proceeding..");
                    ...
                    protected void onPostExecute(Void result) {
                        ...
                        new SweetAlertDialog(pgatway.this, SweetAlertDialog.SUCCESS_TYPE)
                                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                    @Override
                                    public void onClick(SweetAlertDialog sDialog) {
                                        sDialog
                                                .setTitleText("Success!")
                                                .setContentText("Your payment has been completed!")
                                                .setConfirmText("OK")
